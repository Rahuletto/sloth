...
export default function SlidingShelf({
  ...
  return (
    <>
      <motion.div
        initial={{ y: enableDesktopMode ? 50 : 200, opacity: 0, zIndex: -1, pointerEvents: "none" }}
        animate={{ y: open ? 0 : enableDesktopMode ? 50 : 200, opacity: open ? 1 : 0, zIndex: open ? 10 : -1, pointerEvents: open ? "auto" : "none" }}
