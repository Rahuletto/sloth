		...
		<Draggable draggableId={f.i.toString()} index={f.i}>
			{(drag) => (
				<div
					...
					className="w-full lg:min-w-[250px] cursor-grab select-none relative md:w-auto lg:max-w-[20.2vw] max-h-[165px] m-1 bg-box border-2 border-bb rounded-xl md:py-5 md:px-8 py-4 px-5"
				>
